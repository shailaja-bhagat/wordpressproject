...
<div id="tve-thrive_dynamic_list-component" class="tve-component" data-view="DynamicList">
	...
	<div class="dropdown-content">
		<div class="tcb-text-center mb-10 mr-5 ml-5">
			<button class="tve-button orange click" data-fn="editListElements">
				<?php echo __( 'Edit List Items', THEME_DOMAIN ); ?>
			</button>
		</div>
		<div class="tve-control mb-5" data-view="list_type"></div>
