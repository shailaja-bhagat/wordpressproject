...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6">
				...
				<?php if ($integral['contact-email']) { ?><div class="info more-info"><?php echo wp_kses_post($integral['contact-email']); ?>
				</div><?php } ?>
				<?php if ($integral['contact-address']) { ?><div class="info contact-info">
				<span class="fa fa-home fa-md"></span> <?php echo str_replace("\n", "<br>", $integral['contact-address']); ?>
				</div><?php } ?>
				<?php if ($integral['contact-phone']) { ?><div class="info phone-info">
