...
function TDI_import_files() {
	return array(
		array(
			'import_file_name'             => 'Integral Demo Content',
			'local_import_file'            => trailingslashit( get_template_directory() ) . 'inc/demo/integral-demo-content.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'inc/demo/integral-demo-widgets.wie',
			'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'inc/demo/integral-demo-customizer.dat',
		),
	);
}
